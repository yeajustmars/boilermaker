...
;hljs.registerLanguage("bash",e)})();/*! `clojure` grammar compiled for Highlight.js 11.11.1 */
...
;hljs.registerLanguage("clojure",e)})();/*! `clojure-repl` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict";return e=>({name:"Clojure REPL",contains:[{
className:"meta.prompt",begin:/^([\w.-]+|\s*#_)?=>/,starts:{end:/$/,
subLanguage:"clojure"}}]})})();hljs.registerLanguage("clojure-repl",e)})();/*! `rust` grammar compiled for Highlight.js 11.11.1 */
(()=>{var e=(()=>{"use strict";return e=>{
...
;hljs.registerLanguage("rust",e)})();/*! `shell` grammar compiled for Highlight.js 11.11.1 */
