...
+-------------------------------------------------------------------------------\x1b[0m
  ...
  A good place to start is \x1b[32m`boil completion generate`\x1b[0m to generate autocomplete
  to make it easier to explore the command tree. After that, you can try
